...
| **거북목 탐지 모니터링** | 개인별 정상 자세를 캘리브레이션해 기준선을 잡고, 거북목 자세를 실시간으로 알리는 시스템 | MediaPipe, MiDaS, Python | [코드](https://github.com/taeokyoon/Advanced-Capstone-Project) |
...
**거북목 탐지 모니터링** — 자세는 사람마다 기준이 달라 절대 각도로는 판별이 어렵습니다. 사용자별 정상 자세를 먼저 캘리브레이션해 기준선을 세우고, 이탈 시 푸시 알림·자세 유지 시간 기록·일간 대시보드를 제공합니다. 시스템 사용 시 촬영만 했을 때보다 거북목 자세 유지 시간 비율이 약 30% 줄었습니다. 팀 프로젝트이며 제가 맡은 부분은 크로스플랫폼 지원, GUI 스레드 안전성 수정, Firebase 연동 인증 방식 개선입니다 ([CrossPlat_Dev 브랜치](https://github.com/taeokyoon/Advanced-Capstone-Project/commits/CrossPlat_Dev/?author=yeongyurim)).
